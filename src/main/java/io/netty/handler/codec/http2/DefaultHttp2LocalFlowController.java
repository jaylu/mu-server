...
public class DefaultHttp2LocalFlowController implements Http2LocalFlowController {
    ...
    static {
        System.out.println("DefaultHttp2LocalFlowController injected.");
    }
    ...
    private class DefaultState implements FlowState {
        ...
        private void writeWindowUpdate() throws Http2Exception {
            ...
            System.out.println("writing update frame :" + deltaWindowSize + " for id=" + stream.id());
            frameWriter.writeWindowUpdate(ctx, stream.id(), deltaWindowSize, ctx.newPromise())
                .addListener(future -> {
                    if (future.isSuccess()) {
                        System.out.println("window update frame written success: " + deltaWindowSize);
                    } else {
                        System.out.println("window update frame written failed");
                    }
